...
GRACE_TABLE_INFOS_GEOJSON =  {
    ...
    TABLE_CABLE: {
        'id_col': 'id_cable',
        'geom_col': 'geom',
        'select_col': '\'cable\' as typeobj, ST_AsText(ST_Transform(geom, 4326)) as geom, ST_AsText(ST_SnapToGrid(ST_Centroid(ST_Transform(geom, 4326)),0.00001)) as center',
    ...
    TABLE_NOEUD: {
        'id_col': 'id_noeud',
        'geom_col': 'geom',
        'select_col': '\'noeud\' as typeobj, ST_AsText(ST_Transform(geom, 4326)) as geom, ST_AsText(ST_SnapToGrid(ST_Centroid(ST_Transform(geom, 4326)),0.00001)) as center, id_com_insee_noeud as "Insee"',
    ...
    TABLE_BPE: {
        'id_col': 'id_noeud',
        'geom_col': 'geom',
        'select_col': '\'bpe\' as typeobj, ST_AsText(ST_Transform(geom, 4326)) as geom, ST_AsText(ST_SnapToGrid(ST_Centroid(ST_Transform(geom, 4326)),0.00001)) as center, id_com_insee_noeud as "Insee" FROM noeud WHERE noeud.type_logiq_noeud = \'RACCORDEMENT\'',
    ...
    TABLE_CHAMBRE: {
        'id_col': 'id_chbre',
        'geom_col': 'geom',
        'select_col': '\'chambre\' as typeobj, ST_AsText(ST_Transform(n.geom, 4326)) as geom, ST_AsText(ST_SnapToGrid(ST_Centroid(ST_Transform(n.geom, 4326)),0.00001)) as center, n.id_com_insee_noeud as "Insee" FROM noeud n, chambre c WHERE c.id_noeud = n.id_noeud',
