...
GRACE_TABLE_INFOS_GEOJSON =  {
    ...
    TABLE_CABLE: {
        'id_col': 'id_cable',
        'geom_col': 'geom',
        'select_col': '\'cable\' as typeobj, ST_AsText(ST_Transform(geom, 4326)) as geom',
    ...
    TABLE_BPE: {
        'id_col': 'id_noeud',
        'geom_col': 'geom',
        'select_col': '\'bpe\' as typeobj, ST_AsText(ST_Transform(geom, 4326)) as geom, id_com_insee_noeud as "Insee" FROM noeud WHERE noeud.type_logiq_noeud = \'RACCORDEMENT\'',
    ...
    TABLE_SITE_TECHNIQUE: {
        'id_col': 'id_lt',
        'geom_col': 'geom',
        'select_col': '\'site_technique\' as typeobj, ST_AsText(ST_Transform(n.geom, 4326)) as geom, n.id_com_insee_noeud as "Insee" FROM noeud n, local_technique lt WHERE lt.id_noeud = n.id_noeud',
    ...
    TABLE_CHAMBRE: {
        'id_col': 'id_chbre',
        'geom_col': 'geom',
        'select_col': '\'chambre\' as typeobj, ST_AsText(ST_Transform(n.geom, 4326)) as geom, n.id_com_insee_noeud as "Insee" FROM noeud n, chambre c WHERE c.id_noeud = n.id_noeud',
